...
#include "MyGeometrySandbox/Public/GeometryHubActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MYGEOMETRYSANDBOX_API UScriptStruct* Z_Construct_UScriptStruct_FGeometryPayload();
	...
	MYGEOMETRYSANDBOX_API UClass* Z_Construct_UClass_AGeometryHubActor_NoRegister();
	MYGEOMETRYSANDBOX_API UClass* Z_Construct_UClass_AGeometryHubActor();
...
class UScriptStruct* FGeometryPayload::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MYGEOMETRYSANDBOX_API uint32 Get_Z_Construct_UScriptStruct_FGeometryPayload_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryPayload, Z_Construct_UPackage__Script_MyGeometrySandbox(), TEXT("GeometryPayload"), sizeof(FGeometryPayload), Get_Z_Construct_UScriptStruct_FGeometryPayload_Hash());
	}
	return Singleton;
}
template<> MYGEOMETRYSANDBOX_API UScriptStruct* StaticStruct<FGeometryPayload>()
{
	return FGeometryPayload::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FGeometryPayload(FGeometryPayload::StaticStruct, TEXT("/Script/MyGeometrySandbox"), TEXT("GeometryPayload"), false, nullptr, nullptr);
static struct FScriptStruct_MyGeometrySandbox_StaticRegisterNativesFGeometryPayload
{
	FScriptStruct_MyGeometrySandbox_StaticRegisterNativesFGeometryPayload()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("GeometryPayload")),new UScriptStruct::TCppStructOps<FGeometryPayload>);
	}
} ScriptStruct_MyGeometrySandbox_StaticRegisterNativesFGeometryPayload;
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryPayload_Hash() { return 1010108057U; }
	...
	IMPLEMENT_CLASS(AGeometryHubActor, 1405487828);
	template<> MYGEOMETRYSANDBOX_API UClass* StaticClass<AGeometryHubActor>()
	{
		return AGeometryHubActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AGeometryHubActor(Z_Construct_UClass_AGeometryHubActor, &AGeometryHubActor::StaticClass, TEXT("/Script/MyGeometrySandbox"), TEXT("AGeometryHubActor"), false, nullptr, nullptr, nullptr);
